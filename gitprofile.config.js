...
const config = {
  ...
  resume: {
    fileUrl:
      'https://drive.google.com/file/d/1ir2scegLgpIF02q2IyF9hgdIyvIGU_r2/view?usp=sharing', // Empty fileUrl will hide the `Download Resume` button.
  },
  skills: [
    'JavaScript',
    'Python',
