...
const config = {
  ...
  resume: {
    fileUrl:
      'https://drive.google.com/file/d/1wG56D4gjsH7aW1tDUl3xZ1gUxrFiGWYm/view?usp=sharing', // Empty fileUrl will hide the `Download Resume` button.
  },
  skills: [
    'JavaScript',
    'Python',
